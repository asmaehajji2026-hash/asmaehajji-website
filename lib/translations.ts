...
const fr: Translation = {
  ...
  histoire: {
    ...
    paragraphs: [
      ...
      "Je ne promets pas de raccourcis. Je propose un cadre, un accompagnement, et la conviction profonde que chaque femme peut devenir la patronne de sa propre vie.",
    ],
  ...
  diff: {
    ...
    right: [
      ...
      "Tu construis un actif qui te libère de ta présence constante",
  ...
  preuve: {
    ...
    caption:
      "Classement interne — nom de la compagnie, noms et photos des autres agents pixelisés par confidentialité. Résultats individuels, non représentatifs et non garantis.",
  },
  preclose: {
...
const en: Translation = {
  ...
  histoire: {
    ...
    paragraphs: [
      ...
      "I do not promise shortcuts. I offer a framework, support, and a deep belief that every woman can become the CEO of her own life.",
    ],
  ...
  diff: {
    ...
    right: [
      ...
      "You build an asset that frees you from constant presence",
  ...
  preuve: {
    ...
    caption:
      "Internal ranking — company name, other agents' names and photos pixelated for confidentiality. Individual results, non-representative and non-guaranteed.",
  },
  preclose: {
