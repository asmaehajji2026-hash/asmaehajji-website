    ...
    <section className="bg-as-cream-warm py-20 sm:py-28 px-[6%]">
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="max-w-[720px] mx-auto">
          <svg viewBox="0 0 720 210" xmlns="http://www.w3.org/2000/svg" className="w-full block">
            ...
            <text x="130" y="99" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="26" fill="#0F5C4A" letterSpacing="1">80%</text>
            <text x="130" y="116" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="9.5" fill="#555555">psychology</text>

            <rect x="248" y="60" width="14" height="14" rx="2" fill="#0F5C4A"/>
            <text x="268" y="72" fontFamily="var(--font-montserrat), sans-serif" fontSize="12" fill="#555555">Psychology — mindset, confidence, fear of rejection</text>
            <rect x="248" y="84" width="14" height="14" rx="2" fill="#E6E0D6"/>
            <text x="268" y="96" fontFamily="var(--font-montserrat), sans-serif" fontSize="12" fill="#8A7F73">Strategy — sales skills, modern tools</text>

            <rect x="242" y="120" width="466" height="64" rx="3" fill="#E6F0ED" stroke="rgba(15,92,74,0.3)" strokeWidth="1"/>
            <text x="260" y="140" fontFamily="var(--font-montserrat), sans-serif" fontSize="11" fill="#555555" fontStyle="italic">"{t.psychologie.quote}"</text>
            <text x="260" y="176" fontFamily="var(--font-playfair), Georgia, serif" fontSize="11" fill="#0F5C4A" letterSpacing="1">— ASMAE HAJJI</text>
          </svg>
        </div>
