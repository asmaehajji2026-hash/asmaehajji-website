      ...
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="w-full overflow-hidden">
          <svg viewBox="0 0 860 270" xmlns="http://www.w3.org/2000/svg" className="w-full block">
            ...
            {/* LEFT: Traditional job (gray) */}
            <rect x="20" y="20" width="380" height="232" rx="3" fill="#F1EFE8" stroke="#E6E0D6" strokeWidth="1.5"/>
            <text x="210" y="46" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="13" fill="#8A7F73" letterSpacing="3">{t.constat.leftLabel}</text>

            <rect x="70" y="64" width="120" height="40" rx="3" fill="#E8E4DC" stroke="#E6E0D6" strokeWidth="1"/>
            <text x="130" y="84" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="12" fill="#555555" letterSpacing="1">{t.constat.left.youWork}</text>
            <text x="130" y="98" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="9" fill="#8A7F73">{t.constat.left.workHours}</text>
            ...
            <text x="282" y="84" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="12" fill="#555555" letterSpacing="1">{t.constat.left.fixedSalary}</text>
            <text x="282" y="98" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="9" fill="#8A7F73">{t.constat.left.salaryNote}</text>
            ...
            <text x="282" y="156" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="12" fill="#555555" letterSpacing="1">{t.constat.left.inflation}</text>
            <text x="282" y="170" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="9" fill="#8A7F73">{t.constat.left.inflationNote}</text>
            ...
            <text x="204" y="212" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="10" fill="#0F5C4A">{t.constat.left.automationWarning}</text>

            {/* Separator */}
            <line x1="430" y1="20" x2="430" y2="252" stroke="#E6E0D6" strokeWidth="1" strokeDasharray="5 4"/>

            {/* RIGHT: Independent model (emerald) */}
            <rect x="450" y="20" width="390" height="232" rx="3" fill="#E6F0ED" stroke="rgba(15,92,74,0.4)" strokeWidth="1.5"/>
            <text x="645" y="46" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="13" fill="#0F5C4A" letterSpacing="3">{t.constat.rightLabel}</text>

            <rect x="470" y="178" width="100" height="48" rx="3" fill="#E8E4DC" stroke="#E6E0D6" strokeWidth="1"/>
            <text x="520" y="200" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="12" fill="#555555" letterSpacing="1">{t.constat.right.sales}</text>
            <text x="520" y="215" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="9" fill="#8A7F73">{t.constat.right.personal}</text>
            ...
            <text x="648" y="175" textAnchor="middle" fontFamily="var(--font-playfair), Georgia, serif" fontSize="12" fill="#0F5C4A" letterSpacing="1">{t.constat.right.team}</text>
            <text x="648" y="190" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="9" fill="#555555">{t.constat.right.recruitTrain}</text>
            ...
            <text x="645" y="74" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="10.5" fill="#555555" fontStyle="italic">{t.constat.right.anywhere}</text>
            <text x="645" y="90" textAnchor="middle" fontFamily="var(--font-montserrat), sans-serif" fontSize="10.5" fill="#555555" fontStyle="italic">{t.constat.right.homeCountry}</text>
          </svg>
        </div>
